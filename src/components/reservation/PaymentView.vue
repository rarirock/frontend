                                        ...
                                        <!-- <div class="group_discount" style="display: block;">
                                            ...
                                            <div class="tab_wrap3 reset selected">
                                                <div class="tab_tit case2">
                                                    <ul>
                                                        <li><button class="active">L.POINT <strong
                                                                    class="point">조회</strong></button></li>
                                            ...
                                            <div class="wrap_coupon">
                                                <div class="bx_cate">
                                                    <ul class="list_pay_item cate4">
                                                        <li id="point_vip"><button class="">VIP/Friends<span
                                                                    class="txt_cnt">0</span></button></li>
                                                        <li id="point_admission"><button class="">관람권<span
                                                                    class="txt_cnt">0</span></button></li>
                                                        <li id="point_discount"><button class="">할인권<span
                                                                    class="txt_cnt">0</span></button></li>
                                                        <li class="mline" id="point_etc"><button
                                                                class="">제휴포인트/할인</button></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="tooltip_box"><button class="ic_question">?</button>
                                            <div class="tooltip"><strong>L.POINT 적립 안내</strong>
                                                <ul class="list_txt">
                                                    ...
                                                    <li>L.POINT : L.POINT 카드 또는 롯데 신용카드 번호 입력시 회원등급에 따라 차등 적립 됩니다. 단,
                                                        미등록 카드번호 입력시 결제금액의 0.1%가 적립됩니다.</li>
                                                </ul><button class="btn_close">닫기</button>
                                            </div>
                                        </div>
                                        <div class="area_rdo"><span><input type="radio" id="rdoSavingLPointId"
                                                    value="ID" checked=""><label
                                                    for="rdoSavingLPointId">ID적립</label></span><span><input type="radio"
                                                    id="rdoSavingLPointNum" value="CARD"><label
                                                    for="rdoSavingLPointNum">카드번호 적립</label></span></div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="mCustomScrollbar _mCS_2 mCS-autoHide mCS_no_scrollbar"
                                    ...
                                    <div id="mCSB_2"
                                        ...
                                        <div id="mCSB_2_container"
                                            ...
                                            style="position:relative; top:0; left:0;" dir="ltr">
                                            <dl>
                                                <dt><img src="http://caching.lottecinema.co.kr//Media/WebAdmin/ad4566fe08d244faabd1486616f38d58.png"
                                                        alt="매주 월~수 'BC카드데이'" class="mCS_img_loaded"></dt>
                                                <dd><strong>매주 월~수 'BC카드데이'</strong><br><span>이벤트 페이지에서 할인권 다운시 2인 1만원
                                                        할인 (선착순 1천명, 12/5~12/27)</span></dd>
                                            </dl>
                                        </div>
                                    </div>
